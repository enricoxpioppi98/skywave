...
export default async function AboutPage() {
  ...
  return (
    <main className="flex-1 min-h-0 flex flex-col">
      <header className="px-6 md:px-10 py-5 flex items-center justify-between border-b border-[color:var(--border)] shrink-0">
        <Link href={authed ? "/app" : "/"} className="flex items-center gap-3">
      ...
      <article className="flex-1 min-h-0 overflow-y-auto px-6 md:px-10 py-12">
        <div className="max-w-3xl w-full mx-auto">
          ...
          <Section title="Why bands open and close">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-sm">
              <li>
                ...
                upper atmosphere. Higher = more ionization = higher-frequency bands (10m,
                15m, 20m) open for long-distance skip.
              </li>
              <li>
                <strong>Kp index</strong> — a 0-to-9 scale of geomagnetic disturbance. Low Kp
                = stable propagation. High Kp = geomagnetic storm, polar HF absorbed,
          ...
          <Section title="Privacy &amp; data">
            <p>
              All WSPR reception reports are already public — we just mirror a rolling
              6-hour window into Supabase and push Realtime updates. The only thing skywave
              stores about <em>you</em> is your email (for the magic link) and your
              preferences (grid square, favorite bands, optional callsign). Supabase
              Row-Level Security makes sure you can only read your own preferences; no one
